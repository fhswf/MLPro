...
## -- Module  : howto_bf_streams_003_visualise_moving_clouds2d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
This module demonstrates how to visualise the moving clouds 2D data stream provided by MLPro.
...
stream = StreamMLProDynamicClouds2D(pattern = 'static')
my_iter = iter(stream)
