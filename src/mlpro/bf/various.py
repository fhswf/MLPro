...
## -- 2023-02-19  2.0.0     DA       Class Saveable: new custom method _save()
## -------------------------------------------------------------------------------------------------

"""
Ver. 2.0.0 (2023-02-19)
...
## -------------------------------------------------------------------------------------------------
    def save(self, p_path, p_filename=None) -> bool:
        ...
        The default method for saving is to pickle (dill) the entire object. But you can implement
        an own custom method _save() instead.  
...
## -------------------------------------------------------------------------------------------------
    def _save(self, p_path, p_filename=None) -> bool:
        """
        Custom method for your own save procedure. See method save() for further details.
        """
