...
class Persistent (Log):
    ...
    C_PERSIST_TYPE_FILE     = 'File'
    C_PERSIST_TYPE_FOLDER   = 'Folder'
    C_PERSIST_TYPE          = C_PERSIST_TYPE_FILE
...
## -------------------------------------------------------------------------------------------------
    ...
    def load( cls, p_path:str, p_filename:str = None):
        ...
        elif cls.C_PERSIST_TYPE == cls.C_PERSIST_TYPE_FOLDER:
...
## -------------------------------------------------------------------------------------------------
    ...
    def _load_file( cls, p_path:str, p_filename:str):
        """
        Loads content from the given file using dill.
