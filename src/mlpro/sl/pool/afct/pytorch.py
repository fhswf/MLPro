...
#     #     try:
#     #         if len(_param['hidden_size']) != _param['num_hidden_layers']:
#     #             raise ParamError("length of hidden_size list must be equal to num_hidden_layers or an integer.")
#     #     except:
#     #         if not isinstance(_param['hidden_size'], int):
#     #             raise ParamError("length of hidden_size list must be equal to num_hidden_layers or an integer.")
#     #         else:
#     #             _param['hidden_size'] = [_param['hidden_size']] * _param['num_hidden_layers']
        
#     #     if 'activation_fct' not in _param:
#     #         raise ParamError("activation_fct is not defined.")
#     #     try:
#     #         if len(_param['activation_fct']) != _param['num_hidden_layers']:
#     #             raise ParamError("length of activation_fct list must be equal to num_hidden_layers or a single activation function.")
#     #     except:
#     #         if isinstance(_param['activation_fct'], list):
#     #             raise ParamError("length of activation_fct list must be equal to num_hidden_layers or a single activation function.")
#     #         else:
#     #             _param['activation_fct'] = [_param['activation_fct']] * _param['num_hidden_layers']
