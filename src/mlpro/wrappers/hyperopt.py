...
## -------------------------------------------------------------------------------------------------
    def _ofct_hyperopt(self, p_params):
        ...
        for x in range(len(self._model._hyperparam_tuple.get_dim_ids())):
            _id = self._model._hyperparam_tuple.get_dim_ids()
            self._model._hyperparam_tuple.set_value(_id[x], p_params[x])
        ...
        for x in range(len(self._model._hyperparam_tuple.get_dim_ids())):
            _id = self._model._hyperparam_tuple.get_dim_ids()
            hp_name_short = self._model._hyperparam_tuple.get_related_set().get_dim(_id[x]).get_name_short()
...
## -------------------------------------------------------------------------------------------------
    def SetupSpaces(self):
        ...
        for x in range(len(self._model._hyperparam_tuple.get_dim_ids())):
            _id = self._model._hyperparam_tuple.get_dim_ids()
            hp_object = self._model._hyperparam_tuple.get_related_set().get_dim(_id[x])
