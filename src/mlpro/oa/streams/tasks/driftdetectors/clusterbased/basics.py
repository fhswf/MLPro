...
## -------------------------------------------------------------------------------------------------
## -------------------------------------------------------------------------------------------------
class DriftDetectorCBSingle(DriftDetectorCB):
    """
    This is the class for single cluster drift detectors. It raises an event when a drift is detected in a single cluster.

    Parameters
    ----------
    p_clusterer : ClusterAnalyzer
        Related cluster analyzer providing its clusters as the basis for drift detection
    p_property : PropertyDefinitions
    ...
    C_TYPE = 'Single Cluster-based Drift Detector'
...
## -------------------------------------------------------------------------------------------------
## -------------------------------------------------------------------------------------------------
class DriftDetectorCBMulti(DriftDetectorCB):
    """
    This is the class for multi cluster drift detectors.
    """
    pass
