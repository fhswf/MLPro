...
## -- 2023-04-10  0.1.0     DA       First implementation of classes ClusterMembership, ClusterAnalyzer
## -------------------------------------------------------------------------------------------------
...
## -------------------------------------------------------------------------------------------------
    def get_cluster_membership( p_inst : Instance ) -> list[ClusterMembership]:
        """
