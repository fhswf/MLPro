...
This module provides a template class for new cluster appearance to be used in anomaly detection algorithms.
"""
...
## -------------------------------------------------------------------------------------------------
## -------------------------------------------------------------------------------------------------
class NewClusterAppearance (AnomalyCB):
    """
