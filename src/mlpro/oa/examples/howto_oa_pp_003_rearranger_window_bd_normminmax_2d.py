...
## -- Module  : howto_oa_pp_003_rearranger_window_bd_normminmax_2d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
to reduce the stream data to 2 dimensions, a window that buffers the last 50 instances, a boundary
