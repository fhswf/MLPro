...
In game theoretical approach, the player is one who takes decisions based on the actual states in a game. 
A game contains two or more players that can be working cooperatively or competitively.
Each player is supplied with a policy, where the policy can used for decision making process and also optimized.
