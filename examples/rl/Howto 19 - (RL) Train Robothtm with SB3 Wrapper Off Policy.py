...
## -- Package : mlpro
## -- Module  : Train Robothtm with SB3 Wrapper Off-Policy
## -------------------------------------------------------------------------------------------------
## -- History :
## -- yyyy-mm-dd  Ver.      Auth.    Description
## -- 2022-01-11  0.0.0     MRD      Creation
## -- 2022-01-12  1.0.0     MRD      First Release
## -------------------------------------------------------------------------------------------------

"""
Ver. 1.0.0 (2022-01-12)

This module shows how to use SB3 wrapper off policy to tran Robothtm environment
"""
