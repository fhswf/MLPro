...
class Stream4KMeans (StreamMLProBase):
    ...
    C_ID                = 'St4STREAMKMeans'
    C_NAME              = 'Stream4STREAMKMeans'
    C_VERSION           = '1.0.0'
    C_NUM_INSTANCES     = 12

    C_SCIREF_URL        = 'https://riverml.xyz/latest/api/cluster/STREAMKMeans/'
...
## -------------------------------------------------------------------------------------------------
    def _init_dataset(self):
        ...
        # Prepare a test dataset from https://riverml.xyz/latest/api/cluster/STREAMKMeans/
...
## -------------------------------------------------------------------------------------------------
## -------------------------------------------------------------------------------------------------
class AdScenario4STREAMKMeans (OAScenario):

    C_NAME = 'AdScenario4STREAMKMeans'

## -------------------------------------------------------------------------------------------------
    def _setup(self, p_mode, p_ada: bool, p_visualize: bool, p_logging):

        # 1 Get stream from StreamSTREAMKMeans
...
myscenario = AdScenario4STREAMKMeans( p_mode=Mode.C_MODE_REAL,
