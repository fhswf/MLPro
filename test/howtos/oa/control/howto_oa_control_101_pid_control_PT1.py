...
## -- Module  : howto_oa_control_101_pid_control_PT1.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## -- 2025-02-10  0.4.0     ASP      Update simulation parameter
## -------------------------------------------------------------------------------------------------

"""
Ver. 0.4.0 (2025-02-10)
...
#3.2.4 Set RL-Policy 
policy_sb3 = A2C( policy="MlpPolicy",learning_rate = 0.005 ,seed = 42,env = None,_init_setup_model = False)   
...
mycontrolsystem._cycle_limit = 100
