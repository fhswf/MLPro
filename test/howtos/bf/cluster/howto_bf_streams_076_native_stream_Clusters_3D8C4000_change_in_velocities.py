...
## -- Module  : howto_bf_streams_076_native_stream_Clusters_3D8C4000_change_in_velocities.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## -------------------------------------------------------------------------------------------------
    def _setup(self, p_mode, p_visualize:bool, p_logging):
        ...
        stream = StreamMLProClusterGenerator(p_num_dim= 3,
                                             p_num_instances= 4000,
                                             p_num_clusters= 8,
                                             p_radii= [100],
                                             p_change_velocities= True,
                                             p_points_of_change_velocities= [100, 200, 250, 300],
                                             p_num_clusters_for_change_velocities= 4,
                                             p_changed_velocities=[0.1, 0.4, 0.2, 0.33],
