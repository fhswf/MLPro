...
## -- Module  : howto_bf_streams_054_native_stream_Clusters_3D8C2000Dynamic.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## -------------------------------------------------------------------------------------------------
    def _setup(self, p_mode, p_visualize:bool, p_logging):
        ...
        stream = StreamMLProClusterGenerator(p_num_dim= 3,
                                             ...
                                             p_num_clusters= 8,
                                             p_radii= [150, 120, 160, 200, 100, 80, 180, 100],
                                             p_velocities= [0, 0.18, 0.13, 0.4],
                                             p_distribution_bias= [1, 2, 3, 1, 4, 2, 1, 1],
