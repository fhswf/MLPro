...
## -- Module  : howto_bf_streams_079_native_stream_Clusters_3D8C2000_clusters_disappear.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## -------------------------------------------------------------------------------------------------
    def _setup(self, p_mode, p_visualize:bool, p_logging):
        ...
        stream = StreamMLProClusterGenerator(p_num_dim= 3,
                                             ...
                                             p_points_of_disappearance_of_clusters= [400, 600, 200, 300],
                                             p_num_clusters_to_disappear= 4,
