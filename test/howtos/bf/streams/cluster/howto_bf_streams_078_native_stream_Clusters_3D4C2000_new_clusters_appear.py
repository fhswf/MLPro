...
## -- Module  : howto_bf_streams_078_native_stream_Clusters_3D4C2000_new_clusters_appear.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## -------------------------------------------------------------------------------------------------
    def _setup(self, p_mode, p_visualize:bool, p_logging):
        ...
        stream = StreamMLProClusterGenerator(p_num_dim= 3,
                                             ...
                                             p_points_of_appearance_of_clusters= [400, 200, 550, 350],
