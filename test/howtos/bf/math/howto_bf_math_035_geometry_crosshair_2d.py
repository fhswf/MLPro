...
This module demonstrates the functionality of class bf.math.geometry.Crosshair in a 2D plot.
...
if __name__ == '__main__':
    my_crosshair.init_plot( p_plot_settings=PlotSettings( p_view=PlotSettings.C_VIEW_2D ))
