...
## -- Module  : howto_bf_control_001_basic_control_system.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## -- 2024-11-09  1.0.0     DA       Refactoring and documentation
## -------------------------------------------------------------------------------------------------

"""
Ver. 1.0.0 (2024-11-09)

Let's play fox and hunter! This howto demonstrates a basic control system consisting of a dummy
controller and a dummy controlled system. The dimensionality can be changed manually, where in 2d
and 3d mode, a spatial visualization is carried out.
