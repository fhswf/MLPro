...
## -- Module  : howto_bf_math_023_properties_with_explicite_datetime_index.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
In this example, properties are added from outside to a custom class. Furthermore, explicite  
real time stamps are used.
