...
howto_list = {
    "bf_01": "examples.bf.Howto 01 - (Various) Log and timer",
    "bf_02": "examples.bf.Howto 02 - (Math) Spaces, subspaces and elements",
    "bf_03": "examples.bf.Howto 03 - (Various) Store, plot, and save variables",
    "bf_04": "examples.bf.Howto 04 - (ML) Hyperparameters setup",
